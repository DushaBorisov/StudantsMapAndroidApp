...
public class RoomViewModel extends AndroidViewModel {
    ...
    public LiveData<List<Postdb>> getAllPosts() {
        return allPostsData;
    }
    ...
    public LiveData<User> findUserByLogAndPass(String login, String password) {
        return userRepository.findUserByLogAndPass(login, password);
    }
